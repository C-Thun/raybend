...
> 计划文件：`specs/M2-W2-tail.md`。上游是 `specs/M2-W2.md`（49 步的 tracker，1–34 已完成）。
...
| # | 欠账 | 怎么清 |
| --- | --- | --- |
| D1 | `specs/M2-W2.md` 里「⏸ 进行中（2026-09-18 下班暂停）」的残留字样（1.0 那条已完成） | 直接删掉那段说明，并在 tracker 里把 1.0 标干净 |
...
改   BROWSE.md / DESIGN.md / FUTURE.md / ASSISTANCE.md / specs/M2-W2.md （6.4–6.5、D1）
```
