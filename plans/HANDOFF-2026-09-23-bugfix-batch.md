...
| 范围 | 状态 |
| --- | --- |
| **M3-W1 / W2**（编辑器视口：透明挖洞 + wgpu 直绘 + 真实照片 + 渲染线程与监督器） | ✅ 完成，人类已在 Windows 验过 W2 |
| **M3-W3**（显影管线位置、RAW 线性源、编辑栈/issue 落库） | ⬜ **未开工** —— 规划与必答问题在 `plans/HANDOFF-2026-09-23-w3.md` |
| 今天下午/晚上这批（全屏看图、载入流光、直方图固定色、密度与滚动条、17 档重排） | ✅ 完成并提交（`7ff75fb` / `8acb352` / `6b7f76c` / `1df90d1` / `472322d`） |
| **本文档 §2 的 8 条问题** | ⬜ 全部未开工（本轮只排查） |
