...
export const TILE_SIZE_STEPS = [
  /*
   * 2026-09-20（人类）：**最小档加大 ~30%**，整条阶梯重排 ——
   * 旧表 `96,120,144,176,208,256,320,400,512` 的最小档太小：一页塞太多图，
   * 又慢又挤（原话「最小图片尺寸加大30%左右，现在太小了一页图片太多更容易卡顿」）。
   * 新表从 128 起、仍到 512 收，8 段等比约 ×1.19（旧表约 ×1.25）——
   * 中间那档（默认）因此由 208 提到 256：一页的图少一些，也更接近「看得清」的尺寸。
   */
 128, 152, 180, 216, 256, 304, 360, 432, 512,
] as const;
