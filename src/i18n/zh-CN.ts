...
export const zhCN = {
 ...
 "repo.rebuild_progress_metadata": "正在重建：正在补元数据（已补 {done} / 扫到 {total}）…",
...
"browse.fieldPath": "所在路径",
 ...
 "shortcuts.builtinNote": "内建键位（不经过注册表，不可改）：Enter（看图里返回 / 网格里进看图）、方向键在列表里的移动、弹窗与菜单内部的按键。",
 ...
 "cmd.view.chrome.cycle": "三态循环（左右 / 胶片带）",
