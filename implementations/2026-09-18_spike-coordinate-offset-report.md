...
> **2026-09-19 勘误**：本报告的“单位无误”“原点不同”是旧推断，已被截图与系统配置证据推翻。
> Windows 文字大小为 110%，WebView 实际比例约 `1.25×1.10=1.375`；旧代码使用 1.25。
> 旧“CSS 尺寸”又是用同一错误比例反算，形成了自洽的假证据。
> 以下保留调查历史；实际修复与后续规范见 [原生视口开发指导](../docs/native-viewport-coordinate-guide.md)。
